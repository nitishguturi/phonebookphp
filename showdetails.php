		...
		<div class="row">
			<form action="" method="post" class="col-md-12" enctype="multipart/form-data">
				<div class="sigle-input col-md-12">
					...
					<input class="col-md-8" type="text" name="name" placeholder="john" value="<?php echo $result['name']; ?>">
				</div>
				<div class="sigle-input col-md-12">
					<label class="col-md-3">Phone No: </label>
					<input class="col-md-8" type="text" name="phone" placeholder="1234567890" value="<?php echo $result['phone']; ?>">
				</div>
				<div class="sigle-input col-md-12">
					<label class="col-md-3">Email: </label>
					<input class="col-md-8" type="email" name="email" placeholder="john@gmail.com" value="<?php echo $result['email']; ?>">
				</div>
				<div class="sigle-input col-md-12">
					<label class="col-md-3">Address: </label>
					<input class="col-md-8" type="text" name="address" placeholder="new orleans" value="<?php echo $result['address']; ?>">
				</div>
				<div class="sigle-input col-md-12">
